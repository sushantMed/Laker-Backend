...
@pytest.mark.parametrize("zip_code", ["6270", "62704-123", "6270A"])
...
def test_lookup_request_accepts_us_zip_plus_four():
    request = PharmacyLookupRequest(zipCode="62704-1234")

    assert request.zip_code == "62704-1234"
